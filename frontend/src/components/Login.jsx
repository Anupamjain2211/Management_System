  ...
  return (
    <div className='bg-slate-300 min-h-screen flex justify-center items-center'>
      <form className='p-8 bg-white shadow-md rounded-lg w-[30%]'>
        <h1 className='text-4xl mb-10 font-bold underline'>Login Here</h1>
        ...
        <div className='text-center'>
          ...
          <div>
            <div className='mt-8'>
                <p className='text-xl'>If you don't have an account please <Link to="/signup"><span className='font-bold underline'>Signup Here!</span></Link> </p>
            </div>
            <div className='mt-8'>
                <p className='text-xl'><Link to="/forget"><span className='font-bold underline'>Forgot Password?</span></Link> </p>
            </div>
          </div>
        </div>
      </form>
